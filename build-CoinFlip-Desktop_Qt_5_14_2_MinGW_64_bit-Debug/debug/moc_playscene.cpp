...
QT_MOC_LITERAL(1, 10, 12), // "backtochoose"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "PlayScene\0backtochoose\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::backtochoose)) {
                *result = 0;
                return;
            }
        }
